    ...
    print() {
      ...
      <div class="bg-[#b27b34]">
        <ul class="flex">
          ...
          <li><a href="./admin/dashboard" class="block py-2 px-3 text-white hover:underline underline-offset-4">Đăng kí</a></li>
          <li><a href="" class="block py-2 px-3 text-white hover:underline underline-offset-4">Đăng nhập</a></li>
          <li><a href="" class="block py-2 px-3 text-white hover:underline underline-offset-4">Admin</a></li>
